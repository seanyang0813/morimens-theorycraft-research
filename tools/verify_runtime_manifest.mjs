...
function verifiedManifest(){
  ...
  const expected=[...modules.map(n=>'engine/'+n),'build-catalog.json','client-build-data.json','client-build-data-res150.json','client-build-data-res151.json','wheel-mechanics-capability-catalog.json','scenario.json','rules.json'].sort();
