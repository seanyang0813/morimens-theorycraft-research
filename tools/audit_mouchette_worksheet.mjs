...
const report={status:'CONDITIONAL_WORKSHEET_EQUATIONS_MATCH',scope:'Equation cross-check against existing authored combo implementation on synthetic mastery vectors; not gameplay or full original sequence validation',checks,masteryResolved:false,finalDamage:null,scenarioSha256:createHash('sha256').update(bytes).digest('hex')};
