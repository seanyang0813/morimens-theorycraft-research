...
if(process.argv.length!==3){console.error('Usage: node tools/run_catalog_generated_card_pipeline.mjs request.json');process.exitCode=2;}
  ...
  const source={build:request.build,skills:skill.data,battleApi:battleApi.data,commands:command.data,sourceHashes:{Skill:skill.sha256,BattleApi:battleApi.sha256,Cmd:command.sha256}};
