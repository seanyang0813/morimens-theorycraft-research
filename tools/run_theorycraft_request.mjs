...
try{
  ...
  const resource151Operations=new Set(['calculate-snapshot-active-damage','run-snapshot-active-sequence','prepare-skill-command','run-prepared-snapshot-active-skill','run-ulti-energy-effect','run-prepared-snapshot-block-skill','run-prepared-state-active-sequence']);
