...
try{
  ...
  if(selectedBuild==='pc-res151-build51'&&request.operation==='calculate-damage'&&!['FIXED','PURE'].includes(request.input?.damageType))throw new Error('Resource-151 resolved calculator support is limited to Fixed/Pure pre-hit effects');
