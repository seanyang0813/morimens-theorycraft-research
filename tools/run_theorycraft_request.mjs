...
try{
  ...
  if(operation.context.includes('clientBuildData')){
    if(selectedBuild==='pc-res151-build51')throw new Error('Resource-151 client build-stat data has not been reconstructed');
    const clientDataFile=selectedBuild==='pc-res150-build51'?'client-build-data-res150.json':'client-build-data.json';
