...
try{
  ...
  if(['prepare-skill-command','run-prepared-snapshot-active-skill','run-prepared-snapshot-block-skill','run-prepared-state-active-sequence','run-attached-card-pipeline'].includes(request.operation)){
