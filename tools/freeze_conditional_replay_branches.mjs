...
export function freezeConditionalReplayBranches({indexFile,decodedFile,captureCandidateFile,outputFile,now=()=>new Date()}){
  ...
  const input={index,skills:catalogs.Skill,commands:catalogs.Cmd,monsters:catalogs.MonsterConfig,awakeners:catalogs.AwakerConfig,combatBuild:capture.build.id};
