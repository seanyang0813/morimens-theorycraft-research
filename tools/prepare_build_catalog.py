"""Export minimal pinned SKeyDB identities; no inferred combat effects or copied lore."""
...
for filename,collection,keys in [('awakeners.json','characters',['id','name','realm','rarity','type','primaryScalingBase','statScaling']),('wheels.json','wheels',['id','name','realm','rarity','mainstatKey','ownerAwakenerId'])]:
...
out['scope']='Selection identities and primary-stat growth coefficients. Inclusion does not establish combat implementation, equipment legality or current live-game availability.'
