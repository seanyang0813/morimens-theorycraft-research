...
table([['Claim','Auditable local evidence'],['Primary ATK and advancement rounding','mouchette-case-study-primary.json generated through engine/client-build-stats.mjs; Mouchette 198 base to 258 at talent level 10; Arachne remains 138 at explicit level 0'],['Offensive factor order / crit / target rounding','engine/show-damage.mjs; engine/active-target.mjs; original ShowDamageFormula and __GetFinalDamage checks'],['Prism, Beacon and supplied mastery','engine/singularity-realm.mjs; singularity layer/Beacon runtime fixtures and tests'],['Mastery initialization boundary','original-property-initialization.json: 24 original cases; pve-property-input-boundary.json: six original method-chain cases'],['Worksheet equations','mouchette-worksheet-audit.json: '+str(audit['checks'])+' per-hit equation checks over synthetic mastery values and both Shuttle branches. This cross-checks authored implementations, not gameplay.']],[170,352])
