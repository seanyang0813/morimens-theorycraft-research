...
def footer(canvas,doc):
    canvas.setFont('Helvetica',8);canvas.setFillColor(colors.HexColor('#526978'));canvas.drawString(45,28,'Morimens | PC res144 build51 | Conditional research worksheet');canvas.drawRightString(567,28,str(doc.page))
...
table([['Input / effect','Working'],['Mouchette / Arachne ATK','258 / 138 in the accepted maximum-progression reference'],['Stored damage arguments','Mouchette: ceil(258 x 30%) = 78; Arachne: ceil(138 x 20%) = 28'],['Exalt flat Strike bonus','ceil(258 x 250%) = 645'],['Wheel flat per played Strike','ceil(258 x 25%) = 65; cap eight stacks'],['Base-term multipliers','Soulforge Strike: 1.35; amplification: 2.5; Mouchette pursuit Wheel bonus: 1.6'],['After offensive rounding','Crit: 2.5 for both. Mouchette Dominator factor: 1.5. Arachne has no supplied Dominator bonus.']],[175,347])
...
p('<b>Arachne per hit:</b> A(b) = ceil(2.5 x C(739.5 x (1 + 0.02P + 0.02b))).<br/>739.5 = 28 x 1.35 x 2.5 + 645.')
p('<b>Mortal Blast per hit:</b> D(w,k) = ceil(3.75 x C((908.25 + 65w) x (1 + 0.25k) x (1 + 0.02P))).<br/>908.25 = 78 x 1.35 x 2.5 + 645.')
p('<b>Mouchette pursuit per hit:</b> F(w,k) = ceil(3.75 x C((1066.2 + 65w) x (1 + 0.25k) x (1 + 0.02P))).<br/>1066.2 = 78 x 1.35 x 2.5 x 1.6 + 645.')
...
story.append(PageBreak())
p('3. Evidence and what remains missing','TitleX')
