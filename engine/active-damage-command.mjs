...
export function enqueueActiveDamage({scheduler,initialParameters,plus,per,isTargetDead,readParameters,resolveDamage,readCrit,applyHit}){
  ...
  const initialization=initializeActiveDamage({repeat:initial[1]??null,plus,per});
