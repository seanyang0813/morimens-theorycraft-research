...
export function resolveOrdinaryActiveHp(input){
  const keys=['build','damage','block','puncture','hp','retainHp','limit','usedLimit','deathResist','genericImmunity','preventActiveDamage'];
  ...
  if(values.build!==undefined&&!['pc-res144-build51','pc-res150-build51'].includes(values.build))throw new Error('Unsupported BeHit build');
