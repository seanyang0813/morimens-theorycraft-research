...
explicit allowlist of 20 non-resource combat properties: basic damage amplification,
flat damage, Strike-card damage, tentacle damage, three received-damage slots, Fixed and Passive
received-damage slots,
...
- `tools/combat_property_mutation_oracle.py` executes the original ChangeProperty,
  add/subtract, pre/post and property-category helpers for 1,806 cases: 1,710
  ordinary cases across 19 properties plus 96 tentacle-gate cases. Stored values,
...
- `tools/verify_current_combat_property_mutation.py` executes the installed
  ...
  1,806 inherited fixtures. All outputs match the baseline fixture exactly.
