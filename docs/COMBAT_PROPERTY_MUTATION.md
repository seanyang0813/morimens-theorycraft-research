...
explicit allowlist of 19 non-resource combat properties: basic damage amplification,
flat damage, tentacle damage, three received-damage slots, Fixed and Passive
...
- `tools/combat_property_mutation_oracle.py` executes the original ChangeProperty,
  add/subtract, pre/post and property-category helpers for 1,716 cases: 1,620
  ordinary cases across 18 properties plus 96 tentacle-gate cases. Stored values,
...
- `tools/verify_current_combat_property_mutation.py` executes the installed
  ...
  1,716 inherited fixtures. All outputs match the baseline fixture exactly.
