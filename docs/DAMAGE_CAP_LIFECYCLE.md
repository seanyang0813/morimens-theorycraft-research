...
Next verification needs actual state initialization, the joined command-condition/effect sequence, transition-skill internals and independent high-difficulty observations. These synthetic fixtures do not change the publication gate.
