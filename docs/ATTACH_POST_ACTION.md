...
`engine/attach-post-action.mjs` reproduces those eight original-runtime cases and rejects monster targets and other builds. Its output is a request plan. It does not construct or play the temporary card, execute its command, deliver callbacks, traverse later repetitions, or establish gameplay damage.
