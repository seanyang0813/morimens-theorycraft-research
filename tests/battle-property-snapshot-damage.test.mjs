...
const base=()=>({schemaVersion:1,kind:'morimens-battle-property-snapshot-damage',build,snapshotStage:'battle-property-server-live',snapshotCompleteness:'complete-map',baseValue:100,skillArgsPlus:0,tags:['Card_Strike'],
  ...
  targetContext:{critRoll:null,monsterTypeDamageProperties:['damage_per2monster_boss'],targetHasBuff:true,targetHasDebuff:false,targetBlockBarrierStatePresent:false,targetStateDamageProperties:['damage_per2enemy_has_vulnerable']}});
