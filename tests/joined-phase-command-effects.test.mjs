...
test('joined original CheckCondition, parser, expressions and effect bodies match the authored phase transition',()=>{
...
test('installed resource 150 reproduces joined phase command/effect fixtures',()=>{
  ...
  assert.deepEqual(current.changedModules,['FuncTable','Cmd','BattleCmdServer','BattleCmdParser','BEAddStateParent']);
