...
test('sanitized source audit pins the recovered Wheel transition boundaries',()=>{
  ...
  assert.deepEqual(report.summary,{checks:9,passed:9,doomsdayCounterCap:8,arachneCounterCapPerWheel:5,maxRefinementDoomsdayFlatPercent:25,maxRefinementEternalAmplification:40,maxRefinementRotaAmplification:15,eternalSecondCommandRegistered:false});
