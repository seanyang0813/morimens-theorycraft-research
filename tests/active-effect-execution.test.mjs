...
test('original Active effect dispatches through the real child into Damage2SingleTarget',()=>{
  ...
  assert.deepEqual(one.hitEvents,[{getRealDmg:100},{damageVal:100,isCrit:false}]);
  ...
  assert.deepEqual(percent.hitEvents,[{getRealDmg:100},{damageVal:100,isCrit:false},{getRealDmg:100},{damageVal:100,isCrit:false}]);
