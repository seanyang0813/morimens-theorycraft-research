...
const source={skills:skill.data,battleApi:battleApi.data,sourceHashes:{Skill:skill.sha256,BattleApi:battleApi.sha256}};
...
test('catalog plan fails closed on missing live state or unversioned source',()=>{
  ...
  assert.throws(()=>prepareCatalogCardCommandPlan(input,{...source,sourceHashes:{Skill:'bad',BattleApi:battleApi.sha256}}),/Versioned/);
});
