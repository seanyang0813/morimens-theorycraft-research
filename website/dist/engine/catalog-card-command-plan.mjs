...
export function prepareCatalogCardCommandPlan(value,source){
  ...
  return {schemaVersion:1,status:'EXPERIMENTAL',build:input.build,sourceHashes:{...source.sourceHashes},skillId:input.card.tid,commandId:prepared.commandId,baseArguments:prepared.arguments,prepared,plan,
    unresolvedDependencies:[...new Set([...prepared.unresolvedDependencies,...plan.unresolvedDependencies,'Skill and BattleApi exports are caller-supplied versioned inputs'])]};
}
