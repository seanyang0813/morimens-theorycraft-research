...
export function resolveImmunity(input) {
  ...
  if(input.build!=='pc-res144-build51'||!categories.includes(input.category))throw new Error('Unsupported immunity build or category');
  ...
  return {immune:punctureBlocked||categoryBlocked,
    ...
    evidence:['PC144:DamageImmunity'],status:'UNVERIFIED',finalDamage:null};
}
