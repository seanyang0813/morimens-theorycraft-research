...
export function activeTargetDamage(showDamage,data){
  ...
  return {preHitDamage,trace,critBonusPercent:scaledCrit,evidence:['PC144:BattleCmdServer.__GetFinalDamage'],status:'CONFIRMED_FROM_CODE'};
}
